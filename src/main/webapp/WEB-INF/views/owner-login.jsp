			...
			<div class="form-holder">
				<div class="form-content">
					<div class="form-items">
						<h3>Owner Login</h3>
						<form action="/travels/owner/login" method="POST"
							class="requires-validation" >
							<div class="col-md-12">
								<label for="username">Owner Name</label> <input
							...
							<div class="form-button mt-3 btn">
								<button id="sign-in" type="sign-in" class="btn btn-primary">
									Signin</button>
								<a href="/travels/owner/signup" id="register" type="register" class="btn btn-primary">
									SingUp</a>
							</div>
						</form>
					</div>
