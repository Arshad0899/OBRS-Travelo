			...
			<div class="form-holder">
				<div class="form-content">
					<div class="form-items">
						<h3>User Reservation Form</h3>
						<form action="/travels/user/signup" method="POST" class="requires-validation" novalidate>
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<label for="age">Age</label> <input class="form-control"
									type="number" placeholder="Age" id="age" name="age" required />
							</div>
							...
							<div class="col-md-12">
								<label for="phoneNo">Phone Number</label> <input
									...
									id="phoneNo" name="phoneNo" maxlength="10" required />
							</div>
							<div class="col-md-12">
